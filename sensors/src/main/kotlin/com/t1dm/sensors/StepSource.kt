...
/**
 * The hardware edge of the step pipeline (PLAN.private.md §3.5 / Phase 1). Registers a
...
class StepSource(
     ...
     * stay off the UI (PLAN.private.md §2.3). Closes empty on a device with no step counter.
     */
