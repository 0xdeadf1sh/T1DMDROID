 ...
 * (solid-filled), Hello Kitty is soft (thick stroke, rounded). Each glyph exists as three vector
 * drawables (`ic_notif_<glyph>_<style>.xml`); this picks the one for the active [IconStyle].
 *
