...
/**
 * A single CGM source (PLAN.private.md §3.1). The AiDEX X impl is the only one built now, but
 ...
 * (PLAN.private.md §3.1). Auto-discovery may add sources and set the first active; the user
