...
/**
 * Frozen passive-AiDEX pipeline constants (PLAN.private.md §3.1, CGM.md §1/§3, cgm-ingestion
...
object CgmConstants {
    ...
    /**
     * Passive WARMUP heuristic window (PLAN.private.md §3.1). The passive advert carries no
