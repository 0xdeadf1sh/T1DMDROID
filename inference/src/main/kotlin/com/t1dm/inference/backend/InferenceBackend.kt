...
/**
 * The `InferenceBackend` seam (§3.2). One fixed-shape artifact (`T = 52`,
...
/** Static capabilities of a backend (§3.2). */
...
/**
 * The fixed-shape graph input (§2.4). [patches] is `(1,52,18)` step-major,
...
/**
 * The graph output (§2.4). [headRaw] is the flattened `4·6·7 = 168` `head_raw`
