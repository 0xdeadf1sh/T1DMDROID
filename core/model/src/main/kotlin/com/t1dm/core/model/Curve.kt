 ...
 * PLAN.private.md §3.3). These mirror the uniffi records one-to-one; `:core:native`
...
/**
 * A day-long basal schedule (PLAN §3.6 "day-long basal schedule search"). [tzOffsetMin]
