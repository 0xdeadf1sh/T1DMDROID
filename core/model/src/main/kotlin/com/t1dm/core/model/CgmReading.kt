...
/** Where a grid-stamped reading came from (PLAN.private.md §3.1 / §3.6-A). */
...
/** Presentation/gating classification of a reading (PLAN.private.md §3.1). */
...
/**
 * One 5-minute grid sample from a CGM source (PLAN.private.md §3.1). `tsMs` is phone-receive
