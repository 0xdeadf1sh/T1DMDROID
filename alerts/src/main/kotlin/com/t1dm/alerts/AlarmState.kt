...
/**
 * Severity of a firing alarm (§3.6-A). [CRITICAL] is the tier that, from Phase 7,
 ...
 * forecast, no backend, no Rust decode involved (§3.6-A threshold alarm).
 */
 ...
 * (§3.6-A loss-of-signal alarm). Interpolated gap-fill can never postpone it, so
 ...
 * threshold for the sustain window (§3.6-A). This is a signal-QUALITY warning —
